...
// 						<h1 style={{ margin: 0 }}>{isLoggedIn ? `Welcome${user?.name ? `, ${user.name.split(' ')[0]}` : ''}` : 'Rate your favorite stores'}</h1>
...
// 							{!isLoggedIn && <Link to="/signup"><Button variant="secondary">Create Account</Button></Link>}
// 							{isLoggedIn && user?.role === 'admin' && <Link to="/admin"><Button variant="secondary">Admin Dashboard</Button></Link>}
// 							{isLoggedIn && user?.role === 'owner' && <Link to="/owner"><Button variant="secondary">Owner Dashboard</Button></Link>}
// 						</div>
// 					</div>
// 				</Card>
// 			</div>
